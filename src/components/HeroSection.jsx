...
//         });
//         const calculatedData = Object.keys(categoryMap).map(category => ({
//             name: category,
...
//                 amount
//             };
//             setItems(prev => [newItem, ...prev].sort((a, b) => new Date(b.date) - new Date(a.date)));
//         }
...
//             <div className="flex flex-col lg:flex-row gap-6 justify-center max-w-7xl mx-auto font-bricolage" onClick={()=>setFilterPanelOpen(false)} >
...
//                                     className="px-4 py-2 flex items-center gap-2 bg-[#3a3a3a] text-white rounded-lg border border-[#4a4a4a] hover:bg-[#4a4a4a] transition"
//                                 >
//                                     <BsFilter size={16} />
//                                     Filter
//                                 </button>
...
//                                                     <h3 className="font-medium text-white truncate">{item.title || item.name}</h3>
//                                                 </div>
...
//                                                 <button onClick={() => handleEdit(item)} className="p-2 bg-[#3a3a3a] text-gray-300 rounded-lg hover:bg-[#4a4a4a] transition-colors"><BsPencil size={16} /></button>
//                                                 <button onClick={() => handleDelete(item.id)} className="p-2 bg-[#3a3a3a] text-gray-300 rounded-lg hover:bg-[#4a4a4a] transition-colors"><BsTrash size={16} /></button>
//                                             </div>
//                                         </div>
//                                     ))}
//                                 </div>
